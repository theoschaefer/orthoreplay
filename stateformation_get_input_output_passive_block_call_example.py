...
subjects =  ['sub501', 'sub502', 'sub503', 'sub504', 'sub505', 'sub506', 'sub507', 'sub508', 'sub509', 'sub510',
  ...
  'sub531', 'sub532', 'sub533', 'sub534', 'sub535', 'sub536', 'sub537', 'sub538','sub540', 
  'sub541', 'sub543',  'sub545', 'sub546', 'sub547', 'sub548', 'sub549', 'sub550', 
  'sub551', 'sub552', 'sub555', 'sub556', 'sub557', 'sub558', 'sub559', 'sub560', 
...
inputs, outputs, isPassive, states, block, passive_type = get_input_output_stateformation(sub='sub511',csvpath = csvpath, isRecurrent=True, withPassive = True)   
 ...
 # OUTPUTS:
     ...
     # passive_type: [n_trial] which indivates fpr passive trials, to which segment they belong in the block (pre_early /  post_early / pre_late /  post_late)
...
#Subjects to take care of partial blocks: 
#'sub539', 'sub542', 'sub544', 'sub553' ,'sub554'
